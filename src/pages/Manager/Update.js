        ...
        <div className="md:grid md:grid-cols-1 md:gap-6 text-white m-20">
            <div className="mx-20">
                {eventJson && eventJson.eventId && (<>
                    <h1>Pairings</h1>
                    <div>
                        <PairingTable eventId={eventId} rounds={eventJson.pairings} players={eventJson.players[0].entries} scores={eventJson.results[0].scores} />
                    </div>
                            ...
                            {round.pairings.map((pairing, pairingIdx) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <td className="whitespace-nowrap px-1 py-1 text-sm text-gray-500"><PairingResult eventId={eventId} round={roundNumber} board={boardNumber} scores={scores} /></td>
...
function PairingResult({ eventId, round, board, scores }) {
    ...
    const updateResult = (result) => {
        ...
        if(eventInfo) {
            ...
            const pairingIndex = ev.results[0].scores.findIndex(s => s.round === round);
