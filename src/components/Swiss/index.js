...
export default function SwissPresentationView() {
  ...
  return (
    <div className="h-full px-5 pt-4 pb-20">
      <div className="text-center">
        <div className="bg-gh-surface py-4 relative border border-gh-border shadow-lg rounded-lg">
          <h2 className="tracking-tight leading-10 text-gh-text text-5xl sm:leading-none">
            {name}
          </h2>
          <div className="tracking-tight text-gh-textMuted text-lg leading-none mt-3">
