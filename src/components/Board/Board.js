      ...
      <div className="grid grid-cols-1 relative">
        <div className="mx-auto w-full">
          ...
          <div className="relative">
            <div className="mx-auto w-10 bg-orange-900 border-orange-600 border-2 text-lg rounded-sm font-bold text-white">
              {name}
            </div>
          </div>
          ...
          {/* WHITE INFO */}
          <div className="grid grid-cols-6 px-2 text-sm bg-slate-800 py-3 rounded-b-md text-white font-medium border-b-2 border-l-2 border-r-2 border-orange-600">
            <div>{info?.whiteInfo?.rating}</div>
            <div className="col-span-4"><span>{info?.whiteInfo?.name}</span></div>
            <div>{whiteClock}</div>
          </div>

          {/* MOVE & RESULT DETAILS */}
          <div className="relative">
            <div className="mx-auto text-slate-100 text-md font-bold w-28 bg-orange-900 border-2 border-orange-600 text-lg px-2 rounded-sm -mt-2">
              {lastMove}
            </div>
          </div>
        </div>
